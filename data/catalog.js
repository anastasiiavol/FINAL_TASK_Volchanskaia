window.catalog = [{
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/Monki_Festval_Knitted.jpeg', // replace with path to image extracted from catalog layout
    ...
    colors: ['Black', 'White'],
    sizes: ['UK 18'],
    thumbnail: 'img/Boyfriend_T-Shirt.jpeg', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/Boyfriend_T-Shirt_with_Paris_Print.jpeg', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: 'img/levis.jpeg', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/crochet.jpeg', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Green'],
    sizes: ['UK 19'],
    thumbnail: 'img/knitted_jumper.jpeg', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 17'],
    thumbnail: 'img/skinny_jeans.jpeg', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/turtle_jumper.jpeg', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Dark Blue'],
    sizes: ['UK 19'],
    thumbnail: 'img/Only_Busted_Knee_Jean.jpeg', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/Colour_Block.jpeg', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 18', 'UK 19'],
    thumbnail: 'img/Oversized_Cardigan.jpeg', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: 'img/Paul&Joe_Sister_Jumper.jpeg', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}];
